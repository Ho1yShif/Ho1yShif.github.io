  ...
  return (
    <Fragment>
      ...
      <section id='home' ref={homeRef} className="pt-20">
        <div className='.parent-container flex flex-col md:flex-row justify-center items-center gap-10'>
          <div
          ...
          <div
            className={
              "intro-image translate-x-[100px] transition-all opacity-0 duration-700 w-[200px] md:w-[400px] h-[300px] md:h-[400px] bg-contain bg-no-repeat order-2 md:order-2"
            }
            ref={profileRef}
